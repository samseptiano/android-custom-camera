package com.tnsrdm.sfa.Controls
...
/**
 * Created by samuel.septiano on 24/10/2023.
 */
...
class CustomCameraActivity : AppCompatActivity() {
    ...
    private var photoKTPURI: Uri? = null
    ...
    private fun takePhoto() {
        ...
        val imageCapture = imageCapture ?: return
            ...
            //=======================================
                ...
                photoFilee = File.createTempFile("tempFotoKTP_"+SimpleDateFormat(
                    FILENAME_FORMAT,
                    Locale.US
                ).format(System.currentTimeMillis()), ".jpg", storageDir)

                if (photoFilee != null) {
                    photoKTPURI = FileProvider.getUriForFile(this, "com.tnsrdm.sfa.fileprovider", photoFilee)
                }
            //=======================================
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                ...
                override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                    val savedUri = photoKTPURI//Uri.fromFile(photoFile)
                    if (savedUri != null) {
    ...
    private fun getTempDirectory(): File {
        ...
        val storageDir = File(filesDir.absolutePath)
        photoFile = File.createTempFile("tempFotoKTP", ".jpg", storageDir)
        val photoKTPURI = FileProvider.getUriForFile(this, "com.tnsrdm.sfa.fileprovider", photoFile)
        return File(photoKTPURI.path.toString())
    }
    ...
    companion object {
        ...
        private val REQUIRED_PERMISSIONS = arrayOf(Manifest.permission.CAMERA)
         ...
         fun getTempImageFile(ctx: Context): Uri{
            ...
            photoFilee = File.createTempFile("tempFotoKTPOBJ_"+SimpleDateFormat(
                FILENAME_FORMAT,
                Locale.US
            ).format(System.currentTimeMillis()), ".jpg", storageDir)
            return FileProvider.getUriForFile(ctx, "com.tnsrdm.sfa.fileprovider", photoFilee)
        }
    }
